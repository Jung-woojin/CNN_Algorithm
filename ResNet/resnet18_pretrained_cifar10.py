...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), results_dir / 'resnet18_pretrained_best_model.pth')
    
    print("Training finished!")
    
    # 최종 테스트 셋 성능 평가
    model.load_state_dict(torch.load(results_dir / 'resnet18_pretrained_best_model.pth'))
    ...
    with open(results_dir / 'resnet18_pretrained_history.json', 'w') as f:
        json.dump(history, f)
